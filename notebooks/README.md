...
| [minimal-example_web-API-model.ipynb](minimal-example_web-API-model.ipynb) | Usage example | A minimal example of how to use `folktexts` with models hosted through a web API. |
