...
options:
  ...
  --temperature TEMPERATURE
                        [float] Sampling temperature override for text-generation (--cot-prompting). If unset, chain-of-thought uses greedy decoding (0.0), or 1.0 with --enable-thinking. Ignored for multiple-choice/numeric prompting, which reads untempered token probabilities.
