...
def setup_arg_parser() -> ArgumentParser:
    ...
    cli_args = [
        ...
        ("--results-dir",
            str,
            "[str] Directory under which this experiment's results will be saved", False, DEFAULT_RESULTS_DIR),
        ...
        ("--subsampling",
            float,
            "[float] Which fraction of the dataset to use (if omitted will use all data)", DEFAULT_SUBSAMPLING),
